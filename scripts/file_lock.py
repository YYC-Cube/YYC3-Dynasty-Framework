...
"""
file: file_lock.py
description: 文件锁工具 · 防止多进程并发读写 JSON 文件导致数据丢失
author: YanYuCloudCube Team
version: v1.0.0
created: 2026-02-26
updated: 2026-06-08
status: active
tags: [util],[file-lock],[concurrency]

brief: 原子性 JSON 文件读写，支持多 Agent 并发安全

dependencies: fcntl (Linux/macOS), msvcrt (Windows)
exports: atomic_json_write, atomic_json_read, atomic_json_update
