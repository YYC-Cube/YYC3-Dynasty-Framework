...
def project(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(sac, "OPENCLAW_HOME", oc_home)
    monkeypatch.setattr(sac, "OPENCLAW_CFG", oc_home / "openclaw.json")
...
class TestSyncScriptSymlink:
    ...
    def test_skips_self_referential_via_directory_symlink(self, tmp_path):
        ...
        assert created is False, (
            "should skip when dst resolves to same real path as src"
        )
